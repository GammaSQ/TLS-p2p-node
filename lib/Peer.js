...
function getConnection (host, callback){
...
Peer.prototype.connect = function connect(clTxtStream) {
  ...
  if(clTxtStream){
    ...
    if(!host.TLS){
      ...
      connection = getConnection(host, this.handleConnect.bind(this));
    } else {
    ...
    connection = getConnection(this.host, this.handleConnect.bind(this));
  }
